...
export default function RedacaoPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'AboutPage',
    name: 'Redação ACADIM — Núcleo Editorial de Ciência, Saúde e Cidadania',
      ...
      <main className="flex-grow pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
        ...
        <div className="bg-surface-default border border-border-subtle rounded-3xl p-8 sm:p-12 shadow-xl mb-12 relative overflow-hidden">
          ...
          <p className="text-lg sm:text-xl text-text-secondary font-medium max-w-3xl leading-relaxed">
            Núcleo Editorial de Ciência, Saúde e Cidadania da Associação Carioca de Distrofia Muscular.
          </p>
        </div>
