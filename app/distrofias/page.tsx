...
export default function DistrofiasPage() {
  ...
  return (
    <div className="relative min-h-screen bg-surface-subtle text-text-primary flex flex-col">
      <script
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Buscar por nome, gene (ex: DMD, CAPN3, DYSF), proteína ou sinônimo..."
