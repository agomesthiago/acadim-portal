...
export function AcadimLogo({ light = false, compact = false, className = '' }: Props) {
  return (
    <div className={`flex items-center gap-3 group ${className}`}>
      {/* Arco vermelho (símbolo oficial) */}
      ...
      <div className="flex flex-col justify-center">
        <div className="bg-[#0066CC] px-3 py-0.5 rounded-full inline-flex items-center shadow-sm">
        ...
        {!compact && (
          <span
            className={`text-[10px] sm:text-[11px] font-semibold tracking-tight mt-1 leading-tight ${
