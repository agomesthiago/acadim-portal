...
export const STATIC_BASE_NEWS: NewsArticle[] = [
  {
    ...
    excerpt: 'Síntese da Redação ACADIM sobre os dados de ensaios clínicos com salto de éxon e terapias de microdistrofina em 2026, com foco nos critérios de elegibilidade e acesso pelo SUS.',
  ...
  },
  {
    ...
    excerpt: 'Orientação completa compilada pela equipe de direitos e cidadania da ACADIM sobre como obter fraldas, órteses surpodálicas, cadeiras de rodas e fisioterapia pela rede pública.',
